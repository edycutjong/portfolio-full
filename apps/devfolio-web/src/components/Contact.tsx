        ...
        <section id="contact" className="section-padding px-6">
            <div className="container-narrow text-center">
                ...
                <div className="mb-10 animate-slide-up">
                    <button
                        onClick={copyEmail}
                        className="group inline-flex items-center gap-4 px-6 py-4 bg-zinc-800/50 hover:bg-zinc-700/50 border border-zinc-700 hover:border-cyan-500/50 rounded-xl transition-all"
                    >
                        <svg className="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <span className="font-mono text-lg">{email}</span>
                        <span className="text-xs text-muted group-hover:text-cyan-400 transition-colors ml-2">
                ...
                {/* Resume download */}
                <div className="mb-16 animate-slide-up" style={{ animationDelay: '0.15s' }}>
                    <a
                        href="/resume.pdf"
                        download
                ...
                {/* Availability note */}
                <div className="terminal-box max-w-md mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="terminal-body text-sm text-left space-y-2">
