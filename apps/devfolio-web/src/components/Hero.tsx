    ...
    return (
        <section className="min-h-screen flex items-center justify-center px-6 pt-20">
            <div className="container mx-auto max-w-4xl text-center">
                ...
                {/* Subtitle */}
                <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl mx-auto animate-slide-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
                    <a
                        href="#projects"
                        className="px-8 py-4 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full font-semibold text-lg hover:opacity-90 transition-all hover:scale-105"
                    >
                        View Projects
                    </a>
                    <a
                ...
                <div className="mt-16 flex flex-wrap justify-center gap-3 animate-fade-in">
                    {['TypeScript', 'Python', 'Go', 'React', 'Next.js', 'Node.js', 'AWS', 'Docker'].map(
                        (tech) => (
                            <span
                                key={tech}
                                className="px-4 py-2 glass text-sm text-gray-300 hover:text-white hover:border-white/30 transition-colors cursor-default"
                            >
                                {tech}
                            </span>
                        )
