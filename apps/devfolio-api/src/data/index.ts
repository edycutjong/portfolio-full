...
export const projects: Project[] = [
    ...
    },
    {
        ...
        category: 'devops',
        status: 'completed',
        githubUrl: 'https://github.com/edycutjong/portfolio-full',
        featured: false,
        order: 6,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
    },
    {
        ...
        name: 'SolStake',
        slug: 'solstake',
        description: 'Decentralized staking protocol on Solana',
        longDescription:
            'DeFi staking platform with on-chain rewards distribution. Built with Anchor framework for secure smart contract development.',
